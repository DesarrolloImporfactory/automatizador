...
foreach ($resultado_automatizador as $resultado) {
    ...
    if ($tipo <= 6) { // Disparadores
        ...
        $id_accion_padre = isset($parent_map[$parent]) && $parent_map[$parent]['type'] == 'accion' ? $parent_map[$parent]['id'] : null;
        ...
        $id_disparador = isset($parent_map[$parent]) && $parent_map[$parent]['type'] == 'disparador' ? $parent_map[$parent]['id'] : null;
        $id_condicion_padre = isset($parent_map[$parent]) && $parent_map[$parent]['type'] == 'condicion' ? $parent_map[$parent]['id'] : null;
