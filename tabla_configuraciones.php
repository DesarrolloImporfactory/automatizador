...
<script>
    const configFields = [{
            "nombre_campo_mysql": "nombre_configuracion",
            "nombre_campo_visible": "Nombre Configuracion",
            "tipo_campo": "text",
            "requerido": true,
            "aparece_en_tabla": true,
            "seccion_modal": "Configuracion General",
            "class_input_group": "col-12 col-md-12"
        },
        //whatsapp
        {
            "nombre_campo_mysql": "telefono",
            "nombre_campo_visible": "Teléfono",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion WhatsApp",
            "class_input_group": "col-12 col-md-12"
        },
        {
            "nombre_campo_mysql": "id_telefono",
            "nombre_campo_visible": "ID Whatsapp",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion WhatsApp",
        ...
        {
            "nombre_campo_mysql": "id_whatsapp",
            "nombre_campo_visible": "ID WhatsApp Business Account",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion WhatsApp",
        ...
        {
            "nombre_campo_mysql": "token",
            "nombre_campo_visible": "Token WhatsApp API",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion WhatsApp",
        ...
        {
            "nombre_campo_mysql": "webhook_url",
            "nombre_campo_visible": "Token Webhook URL",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion WhatsApp",
        ...
        {
            "nombre_campo_mysql": "whatsapp_button",
            "nombre_campo_visible": "",
            "tipo_campo": "button",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion WhatsApp",
            "class_input_group": "col-12 col-md-12",
            "text": "<i class='fa fa-whatsapp'></i>Conectar WhatsApp Business",
            "onclick": "launchWhatsAppSignup()"
        },
        //email
        {
            "nombre_campo_mysql": "server",
            "nombre_campo_visible": "Server",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
            "class_input_group": "col-12 col-md-6"
        },
        {
            "nombre_campo_mysql": "port",
            "nombre_campo_visible": "Port",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
        ...
        {
            "nombre_campo_mysql": "security",
            "nombre_campo_visible": "Security",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
        ...
        {
            "nombre_campo_mysql": "from_name",
            "nombre_campo_visible": "From Name",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
        ...
        {
            "nombre_campo_mysql": "from_email",
            "tipo_campo_visible": "From Email",
            "tipo_campo": "email",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
        ...
        {
            "nombre_campo_mysql": "auth_required",
            "nombre_campo_visible": "Auth Required",
            "tipo_campo": "checkbox",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
        ...
        {
            "nombre_campo_mysql": "usuario",
            "nombre_campo_visible": "Usuario Email",
            "tipo_campo": "text",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
        ...
        {
            "nombre_campo_mysql": "contrasena",
            "nombre_campo_visible": "Contraseña Email",
            "tipo_campo": "password",
            "requerido": false,
            "aparece_en_tabla": false,
            "seccion_modal": "Configuracion Email",
    ...
    $(document).ready(function() {
        ...
        $('#configForm').submit(function(event) {
            ...
            let formData = {
                id: $('#configId').val(),
                action: $('#configId').val() ? 'update' : 'create'
            };
            configFields.forEach(field => {
                if (field.tipo_campo !== 'button') {
